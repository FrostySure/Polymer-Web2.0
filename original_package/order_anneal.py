...
data="""
 include "order_system.in.init"  #potential
 read_data  "order_system.data"   #orginal structure
 include "order_system.in.settings"  #para
...
# data=""" include "order_system.in.init"  #potential
#  read_data  "order_system.data"   #orginal structure
#  include "order_system.in.settings"  #para
# minimize 1.0e-5 1.0e-7 1000 10000   #force energy
# write_data final_300K.data"""
